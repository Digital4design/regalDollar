    ...
    {	
		...
		return Datatables::of($result)
				...
				->addColumn('action', function ($result){
                    return '<a href ="'. url('admin/page-management/').'/'.Crypt::encrypt($result->id).'/edit"  class="btn btn-xs btn-primary edit"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit </a>
                    | <a href ="'. url('/').'/'.$result->page_slug.'" target="_blank" class="btn btn-xs btn-warning view"><i class="fa fa-eye" aria-hidden="true"></i> View</a> 
