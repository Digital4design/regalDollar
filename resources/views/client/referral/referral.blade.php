...
<div class="row">
  ...
  <div class="col-xl-6">
    <form id="contact_frm" method="post" action="{{ url('/client/share-freind-management/referralRequest') }}" id="registrationform" name="registration" enctype="multipart/form-data">
      {{ csrf_field() }}
