...
<script>
   ...
   $(function() {
       ...
       $('#dataTable').DataTable({
           ...
           order: [[1,'desc']],
           ajax: '{!! url("/client/notifications-managment/notification-data") !!}',
           columns: [
               { data: 'first_name', name: 'first_name', orderable: true },
               { data: 'plan_name', name: 'plan_name', orderable: true , searchable: true},
               { data: 'plan_end_date', name: 'plan_end_date', orderable: true , searchable: true},
       ...
       swal({
             ...
             buttonsStyling: false
   		    ...
   		    if (actionButton) {
                   ...
                   $.ajax({
                       url:'{{ url("/client/withdraw-request-managment/delete") }}'+'/'+id,
                       type: 'GET',
                       success:function(){
