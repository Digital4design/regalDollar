                ...
                <div class="nav-content">
                    ...
                    <div id="kode-responsive-navigation" class="dl-menuwrapper">
                        ...
                        <ul class="dl-menu">
                            ...
                            <li><a class="show_drop_down" href="#investment">Investment Plans</a>
                        ...
                        <li class="menu-item kode-parent-menu"><a href="/faq">FAQ</a></li>

                        <li class="menu-item kode-parent-menu"><a href="/about_us">About Us</a></li>
                    ...
                    <div class="navigation">
                        ...
                        <ul>
                            ...
                            <li class="menu-item kode-parent-menu"><a href="/faq">FAQ</a>

                            <span class="nav-separator"></span></li>

                            <li class="menu-item kode-parent-menu"><a href="{{ url('/about_us') }}/">About Us</a>

                            <span class="nav-separator"></span></li>

                            <li class="menu-item kode-parent-menu"><a href="{{ url('/contact_us') }}">Contact Us</a><span class="nav-separator"></span></li>
