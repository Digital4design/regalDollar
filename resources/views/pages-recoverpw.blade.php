        ...
        <div class="wrapper-page">
            <div class="card overflow-hidden account-card mx-3">
                <div class="bg-primary p-4 text-white text-center position-relative">
                    <h4 class="font-20 mb-4">Reset Account Password</h4>
                ...
                <div class="account-card-content">
                    <div class="alert alert-success m-t-30" role="alert">
                        Enter your email address. If a valid account exists, you should receive an email shortly.
                    </div>
					 @if (session('status'))
            ...
            <div class="m-t-40 text-center">
                <p>Know your password? <a href="{{ url('/register') }}" class="font-500 text-primary"> Sign In here </a> </p>
