		...
		<div class="wrapper-page">
            <div class="card overflow-hidden account-card mx-3">
                <div class="bg-primary p-4 text-white text-center position-relative">
                    ...
                    <a href="index" class="logo logo-admin"><img src="{{ URL::asset('assets/images/peacock.png') }}" height="24" alt="logo"></a>
                </div>
                <div class="account-card-content">
                    <form method="post" class="form-horizontal m-t-30" action="{{ url('/login') }}">
                        <div class="form-group">
                            <label for="username">Username</label>
                            <input type="email" class="form-control" name="email" id="username" placeholder="Username or Email">
							@if ($errors->has('email'))
