            ...
            <tr>
                <td align="center" height="100%" valign="top" width="100%">
                    ...
                    <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width:600px;padding: 30px;" bgcolor="#FFFFFF">
                        <tr>
                            <td align="center" valign="top">
                                <p style="font-size: 24px;line-height:32px;font-family: Helvetica, Arial, sans-serif;text-align: left;color:#222222;margin: 0 0 15px 0;padding:0;font-weight: bold;">Well Come Mail</p>
                                <p style="font-size: 16px;line-height:26px;font-family: Helvetica, Arial, sans-serif;text-align: left;color:#444444;margin: 0 0 15px 0;padding:0;">Hi {{$mailData['user_name']}}, </p>
                                <p style="font-size: 16px;line-height:26px;font-family: Helvetica, Arial, sans-serif;text-align: left;color:#444444;margin: 0 0 15px 0;padding:0;"> Admin has register you on RegalDollar</p>
                                <p style="font-size: 16px;line-height:26px;font-family: Helvetica, Arial, sans-serif;text-align: left;color:#444444;margin: 0 0 15px 0;padding:0;">You can complete your Profile </p>
                                <p style="font-size: 16px;line-height:26px;font-family: Helvetica, Arial, sans-serif;text-align: left;color:#444444;margin: 0 0 15px 0;padding:0;"> Email : {{ $mailData['user_email']}} </p>
                                <p style="font-size: 16px;line-height:26px;font-family: Helvetica, Arial, sans-serif;text-align: left;color:#444444;margin: 0 0 15px 0;padding:0;"> Password : {{ $mailData['user_password']}} </p>
