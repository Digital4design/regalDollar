                     ...
                     <div class="row">
                        ...
                        <div class="col-sm-6">
                           <div class="input-group mb-3">
                              ...
                              <input class="form-control" name="plan_name" value="{{ old('plan_name',(isset($planData) && !empty($planData->plan_name)) ? $planData->plan_name : '' ) }}" />
                        ...
                        <div class="col-sm-6">
                           <div class="input-group mb-3">
                              ...
                              <input class="form-control" name="slogan" value="{{ old('slogan',(isset($planData) && !empty($planData->slogan)) ? $planData->slogan : '' ) }}" />
                        ...
                        <div class="col-sm-6">
                           <div class="input-group mb-3">
                              ...
                              <input type="number" class="form-control" name="plan_fee" {{ ( $is_disable == "1") ? 'disabled' : '' }} value="{{ old('plan_fee',(isset($planData) && !empty($planData->plan_fee)) ? $planData->plan_fee : '' ) }}" />
                              @if($is_disable == "1")
                              <span style="display:initial;" class="invalid-feedback" role="alert">
                        ...
                        <div class="col-sm-6">
                           <div class="input-group mb-3">
                              ...
                              <input type="file" class="form-control" name="plan_doc[]" multiple />
                        ...
                        <div class="col-sm-6">
                           <div class="input-group mb-3">
                              ...
                              <input class="form-control" name="interest_rate" {{ ( $is_disable == "1") ? 'disabled' : '' }} value="{{ old('interest_rate',(isset($planData) && !empty($planData->interest_rate)) ? $planData->interest_rate : '' ) }}" />
                              @if($is_disable == "1")
                              <span style="display:initial;" class="invalid-feedback" role="alert">
                        ...
                        <div class="col-sm-6">
                           <div class="input-group mb-3">
                              ...
                              <input class="form-control" type="text" name="time_investment" {{ ( $is_disable == "1") ? 'disabled' : '' }} value="{{ old('time_investment',(isset($planData) && !empty($planData->time_investment)) ? $planData->time_investment : '' ) }}" />
                              @if($is_disable == "1")
                              <span style="display:initial;" class="invalid-feedback" role="alert">
                        ...
                        <div class="col-sm-6">
                           <div class="input-group mb-3">
                              ...
                              <input class="form-control" type="text" name="view_details_url" value="{{ old('view_details_url',(isset($planData) && !empty($planData->view_details_url)) ? $planData->view_details_url : '' ) }}" />
                        ...
                        <div class="col-sm-6">
                           <div class="input-group mb-3">
                              ...
                              <select name="status" id="plan_status">
                                 <option value="1" {{ $planData->status == '1' ? 'selected="selected"' : '' }}>Active</option>
                                 <option value="0" {{ $planData->status == '0' ? 'selected="selected"' : '' }}>Deactive</option>
                              </select>
                        ...
                        <div class="col-sm-6">
                           <div class="input-group mb-3">
                              ...
                              <input class="form-control" type="date" name="plan_valid_from" value="{{ old('plan_valid_from',(isset($planData) && !empty($planData->plan_valid_from)) ? $planData->plan_valid_from : '' ) }}" />
                        ...
                        ?>
                           <div id="tab_logic" class="col-sm-12">
                              <div class="input-group mb-3">
                                 ...
                                 <input class="form-control" type="text" name="descritpion[]" placeholder="" value="{{ old('descritpion',(isset($des) && !empty($des)) ? $des : '' ) }}" />
