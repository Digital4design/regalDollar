...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 text-right my-3">
            <a href="{{ url('/admin/footer-menu-management/add-footer-menu') }}"><button class="btn btn-xs btn-primary" type="button">Add Footer Menu</button></a>
        </div>
		<div class="col-lg-12">
            <div class="card">
                <div class="card-body">
...
$(function() {
    ...
    $('#myTable').DataTable({
        ...
        order: [[1,'desc']],
        ajax: '{!! url("/admin/footer-menu-management/menu-data") !!}',
        columns: [
            //{ data: 'plan_name', name: 'plan_name', orderable: true },
            { data: 'section', name: 'section', orderable: true , searchable: true},
            { data: 'menu_name', name: 'menu_name', orderable: true , searchable: true},
    ...
    swal({
          ...
          buttonsStyling: false
		    ...
		    if (actionButton) {
                ...
                $.ajax({
                    url:'{{ url("/admin/footer-menu-management/delete") }}'+'/'+id,
                    type: 'GET',
                    success:function(){
