          ...
          <div class="slimscroll-menu" id="remove-scroll">
              ...
              <div id="sidebar-menu">
                  ...
                  <ul class="metismenu" id="side-menu">
                      ...
                      <li class="menu-title">Contact Form</li>
                      <!--li>
					...
					<li class="menu-title">Setting</li>
						<li>
                          <a href="{{ url('/admin/page-management') }}" class="waves-effect"><i class="ti-email"></i><span>Static Pages</span></a>
						</li>
						<li>
                          <a href="{{ url('/admin/contact-page-settings') }}" class="waves-effect"><i class="ti-email"></i><span>Contact Setting </span></a>
						</li>
						<li>
                          <a href="{{ url('/admin/footer-menu-management') }}" class="waves-effect"><i class="ti-email"></i><span>Footer Menu</span></a>
						</li>
