            ...
            @endif
               ...
               {{ csrf_field() }}
                  ...
                  <div class="form-group @error('phone')">
                     ...
                     aria-required="true"
                     aria-invalid="false"
                     value="{{ old('phone',(isset($userData) && !empty($userData->phone)) ? $userData->phone : '' ) }}"
                     />
                  </div>
                  @if ($errors->has('phone'))
                  <span style="display:initial;" class="invalid-feedback" role="alert">
                  ...
                  <div class="form-group @error('message')">
                     ...
                     <textarea name="message" id="message">{{ old('message',(isset($userData) && !empty($userData->message)) ? $userData->message : '' ) }}</textarea>
                  </div>
